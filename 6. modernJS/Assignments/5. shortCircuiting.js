...
//     const {programmingLanguage: lang} = obj;
//     // console.log(lang);
//     console.log(obj.programmingLanguage==='Java' ? true:false);
// };

function hasExamplesInJava(book) {
    const {programmingLanguage: lang} = book;
  console.log(lang.includes('Java') ? true : false);
}
