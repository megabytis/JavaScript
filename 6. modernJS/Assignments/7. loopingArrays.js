...
// made by me ❌\
// for(const bks of books) {
//     if(typeof(bks.author) === String) {
//         allAuthors.push(bks.author);
//     }
//     else {
//         for(const objBooks of bks.author) {
//             allAuthors.push(objBooks);
//         }
//     }
// };
...
for (const book of books) {
  if (typeof book.author === 'string') {
    ...
    for (const authorrrrrr of book.author) {
      allAuthors.push(authorrrrrr);
    }
  }
}

// ⚠️⚠️⚠️ IMPORTANT ⚠️⚠️⚠️
// here the diference is in 'string' V/S String: ----
const l = 'lauda';
console.log(typeof l === String); // return false
console.log(typeof l === "string"); // returns true
// typeof returns a string like 'string', not the actual String object.
...
for(const [authorIndex, authorName] of allAuthors.entries()) {
    console.log(`${authorIndex+1}. ${authorName}`);
}